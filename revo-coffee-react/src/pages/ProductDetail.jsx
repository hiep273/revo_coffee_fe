...
export default function ProductDetail() {
  ...
  if (loading) {
    return (
      <div className="bg-text-light min-h-screen py-12 flex items-center justify-center">
        <div className="text-xl font-nunito text-primary">Đang tải thông tin sản phẩm...</div>
      </div>
    );
  }
